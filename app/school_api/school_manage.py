...
class TeacherAnswer(Resource):

    answer_args = {
        'ask_id': fields.Int(required=True),
...
school_api.add_resource(TeacherAnswer, '/student/TeacherAnswer', endpoint='answer')
